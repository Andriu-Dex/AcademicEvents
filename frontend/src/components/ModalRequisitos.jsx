...
import { X, Calendar, Users, CheckCircle, Target, FileText, AlertCircle, Zap, Pause } from "lucide-react";
            ...
            >
                <div className="modal-requisitos-header">
                    <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                        ...
                        <span className={`badge badge-estado ${evento.est_eve?.toLowerCase() === 'activo' ? 'activo' : 'inactivo'}`}>
                ...
                <div className="modal-requisitos-cuerpo">
                    <div className="seccion-requisitos">
                        ...
                        <div className="info-item">
                            ...
                            <span className="info-value">{formatearFechaUTC(evento.fec_ini_eve)}</span>
                        </div>
                        <div className="info-item">
                            <span className="info-label">Finalización:</span>
                            <span className="info-value">{formatearFechaUTC(evento.fec_fin_eve)}</span>
                        </div>
                        <div className="info-item">
                    ...
                    <div className="seccion-requisitos">
                        ...
                        <div className="info-item">
                            ...
                            <span className="info-value">{evento.modalidad || "No especificada"}</span>
                        </div>
                        <div className="info-item">
                    ...
                    <div className="seccion-requisitos">
                        ...
                        <p style={{ marginBottom: '1rem' }}>
                            {evento.requisitos || "No se han especificado requisitos generales."}
                        </p>
                    ...
                    <div style={{ marginTop: '1rem', textAlign: 'center', color: '#6b7280' }}>
                        <p>Para inscribirse en este evento, inicie sesión o regístrese en la plataforma.</p>
                    </div>
                </div>
            </div>
        </div>
