...
const AdminReporteMes = () => {
    ...
    return (
        <div className="reporte-mes-container">
            <h2 style={{ color: "#8a1538", textAlign: "center", marginBottom: "1rem" }}>
                Reporte Mensual de Eventos
            </h2>
            <div className="reporte-mes-filtros" style={{ display: "flex", gap: "1rem", justifyContent: "center", marginBottom: "2rem" }}>
            ...
            {loading ? (
                ...
                <>
                    <table className="reporte-mes-table" style={{ width: "100%", background: "#fff", borderRadius: "10px", boxShadow: "0 2px 8px #0001", marginBottom: "1.5rem" }}>
                        <thead>
                        ...
                        <tbody>
                            {eventos.length === 0 ? (
                                <tr>
                                    <td colSpan={8} style={{ textAlign: "center" }}>No hay eventos para este mes y año.</td>
                                </tr>
                            ) : (
                                eventos.map((ev, idx) => (
                                    <tr key={idx}>
                        ...
                        {eventos.length > 0 && (
                            <tfoot>
                                <tr>
                                    <td colSpan={7} style={{ textAlign: "right", fontWeight: "bold" }}>Total del mes:</td>
