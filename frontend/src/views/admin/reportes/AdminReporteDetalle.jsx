      ...
      <div className="reporte-cabecera">
        <div className="reporte-info">
          ...
          <div className="info-evento-detalle">
            <div>
              <p>
                <b>Creador:</b> {cab_eve.cre_eve.nom_usu}{" "}
                {cab_eve.cre_eve.ape_usu}
              </p>
            </div>
            <div>
              <p>
                <b>Duración:</b> {cab_eve.dur_hor_eve} horas
              </p>
            </div>
            <div>
              <p>
                <b>Fecha inicio:</b> {cab_eve.fec_ini_eve.slice(0, 10)}
              </p>
            </div>
            <div>
              <p>
                <b>Fecha fin:</b> {cab_eve.fec_fin_eve.slice(0, 10)}
              </p>
            </div>
          </div>
        </div>
