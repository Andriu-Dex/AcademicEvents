...
1. **Control de versiones y gestión de cambios**
   ...
   * Utilizar Git con commits, pull requests e issues.
   * Usar Git Flow para el control de ramas, o justificar si se usa otro flujo de trabajo mejor.
...
3. **Estudiantes**
   ...
   * Perfil debe contener: cédula, nombres, apellidos, correo institucional, carrera (editable), y documentos PDF (carrera, cédula, papeleta de votación, certificado de inscripción, carta de motivación).
   * Inscripción a cursos requiere aprobación del administrador que revise documentos PDF.
...
* **Interfaz del usuario**
  ...
  * Perfil con listado de cursos inscritos y estados (Finalizado, En espera, etc.).
  * Buscador avanzado para cursos y eventos.
* **Restricciones**

  * Solo una nota final por estudiante y curso.
  * Los administradores no pueden modificar sus propias notas de cursos.
* **Documentación**
