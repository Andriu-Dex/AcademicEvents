...
const styles = StyleSheet.create({
    ...
    errorCard: {
        ...
        borderWidth: 1,
        borderColor: theme.colors.errorBorderLight,
        alignItems: "center",
        gap: 10,
    },
    errorTitle: {
        fontSize: 13,
        fontWeight: "700",
        color: theme.colors.errorTextStrong,
    },
    errorSubtitle: {
        fontSize: 12,
        color: theme.colors.errorTextStrong,
    ...
    featuredBadge: {
        ...
        alignItems: "center",
        gap: 6,
        backgroundColor: theme.colors.eventImageOverlayDark,
    ...
    datePill: {
        ...
        paddingVertical: 5,
        borderWidth: 1,
        borderColor: theme.colors.eventAccentBorderLight,
    },
    datePillText: {
        fontSize: 11,
        fontWeight: "700",
    ...
    carouselDot: {
        ...
        height: 7,
        borderRadius: 4,
        backgroundColor: theme.colors.primary22,
    },
    carouselDotActive: {
        width: 18,
        backgroundColor: theme.colors.primary,
